  ...
  return (
    <div className="bg-gray-800">
      ...
      <div className="flex flex-row items-center justify-between w-11/12 max-w-maxContent text-richblack-400 mx-auto  pb-14 text-sm">
        {/* Section 1 */}
        <div className="flex justify-between lg:items-start items-center flex-col lg:flex-row gap-3 w-full text-gray-400">
                ...
                <div
                  ...
                  className={` ${
                    BottomFooter.length - 1 === i
                      ? ""
                      : "border-r border-richblack-700 cursor-pointer hover:text-gray-200 transition-all duration-200 text-gray-400"
                  } px-3 `}
                >
          ...
          <div className="text-center text-gray-400 font-bold ">Made with ❤️ CodeHelp © 2023 Studynotion</div>
        </div>
      </div>
    </div>
  );
