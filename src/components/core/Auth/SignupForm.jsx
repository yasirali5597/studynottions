...
import Tab from "../../comman/Tab.jsx"
        ...
        <div className="flex gap-x-4">
          <label>
            ...
            <input
              ...
              className="w-full rounded-[0.5rem] bg-gray-700 p-[12px] text-white"
            />
          </label>
          <label>
            <p className="mb-1 text-[0.875rem] leading-[1.375rem] text-white">
        ...
        <div className="flex gap-x-4">
          <label className="relative">
            ...
            <input
              ...
              className="w-full rounded-[0.5rem] bg-gray-700 p-[12px] pr-10 text-white"
            />
            <span
          ...
          <label className="relative">
            ...
            <input
              ...
              style={{
                boxShadow: "inset 0px -1px 0px rgba(255, 255, 255, 0.18) text-white",
              }}
              className="w-full rounded-[0.5rem] bg-gray-700 p-[12px] pr-10 text-white"
            />
            <span
