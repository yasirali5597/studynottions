  ...
  return (
    <>
      <form onSubmit={handleSubmit(submitProfileForm)}>
        {/* Profile Information */}
        <div className="my-6 flex flex-col gap-y-3 rounded-md border-[1px] border-richblack-700 bg-richblack-800 p-8 px-12">
          ...
          <div className="flex flex-col gap-5 lg:flex-row rounded-lg">
            <div className="flex flex-col gap-2 lg:w-[48%]">
              ...
              <input
                ...
                className="form-style rounded-md p-2 bg-gray-400 "
