    ...
    <>
      <form onSubmit={handleSubmit(submitPasswordForm)}>
        <div className="my-10 flex flex-col gap-y-6 rounded-md border-[1px] border-richblack-700 bg-richblack-800 p-8 px-12">
          <h2 className="text-lg font-semibold text-white">Password Update</h2>
          <div className="flex flex-col gap-5 lg:flex-row">
            <div className="relative flex flex-col gap-2 lg:w-[48%]">
              ...
              <input
                ...
                className="form-style bg-gray-400  text-black placeholder:text-gray-500  rounded-md p-2  "
        ...
        <div className="flex justify-end gap-2">
          ...
          <IconBtn type="submit" text="Update" className="text-white " />
        </div>
      </form>
    </>
  )
