...
import LearningLanguageSection from "../components/core/HomePage/LearningLanguageSections";
    ...
    <div>
      ...
      >
        <Link to={"/signup"}>
          ...
          >
            <div
              className="flex border border-gray-600 flex-row items-center gap-2 rounded-full px-10 py-[5px]
